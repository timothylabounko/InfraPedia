...
<div
	class="flex shrink-0 flex-nowrap items-center gap-2 overflow-x-auto border-b border-black/10 px-3 py-2 {toneClass}"
>
	<BackButton href="/" label="Library" />
	...
	<button
		...
		class="h-9 shrink-0 rounded-md border border-slate-900 bg-slate-900 px-3 text-sm font-medium leading-none text-white hover:bg-slate-800"
		onclick={onSave}
	>
		{saveLabel}
	</button>
